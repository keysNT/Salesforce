...
?>
<table cellpadding="0" cellspacing="0" class="wp-list-table widefat fixed striped pages" id="contact">
    <caption>
        <h1 class="caption">Table report sync Contact to Salesforce</h1>
    </caption>
    <tr>
    ...
    for ($i=$start; $i<$end; $i++){
        ...
        <tr>
            ...
            <td>
                <a href="<?= admin_url().'user-edit.php?user_id='.$contact['user_id']; ?>">
                    <?= $contact['user_id']; ?>
                </a>
            </td>
            <td>
                <a href="<?= $data['instance_url'].'/one/one.app#/sObject/'.$contact['salesforce_id']; ?>">
