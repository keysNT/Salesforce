...
<table cellpadding="0" cellspacing="0" class="wp-list-table widefat fixed striped pages" >
    <caption>
        <h1 class="caption">Table queue sync Contact to Salesforce</h1>
    </caption>
    <tr>
        ...
        <th class="syncQueue"><?php echo __('Name', 'SALESFORCE_TEXT_DOMAIN');?></th>
        ...
        <tr>
            ...
            <td>
                <form action="admin-post.php" method="post">
                    <input type="hidden" name="action" value="sync_contact"/>
